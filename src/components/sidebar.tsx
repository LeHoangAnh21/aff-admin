...
const ExampleSidebar: FC = function () {
  ...
  const [userData] = useAtom(userAccountStore);
            ...
            <Sidebar.Items>
              <Sidebar.ItemGroup>
                ...
                <Sidebar.Collapse
                  ...
                  open={isUsersOpen}
                >
                  {userData.roleLabel === "ACCOUNTANT" && (
                    <>
                      <Sidebar.Item
                        as={Link}
                        to="/users/withdraw"
                        className={
                          "/users/withdraw" === currentPage
                            ? "bg-gray-100 dark:bg-gray-700"
                            : ""
                        }
                      >
                  ...
                  {userData.roleLabel === "STAFF" && (
                    <>
                      <Sidebar.Item
                        as={Link}
                        to="/users/order"
                        className={
                          "/users/order" === currentPage
                            ? "bg-gray-100 dark:bg-gray-700"
                            : ""
                        }
                      >
                  ...
                  {userData.roleLabel === "ADMIN" && (
                    <>
                      ...
                      <Sidebar.Item
                        as={Link}
                        to="/users/consultation-request"
                        className={
                          "/consultation-request" === currentPage
                            ? "bg-gray-100 dark:bg-gray-700"
                            : ""
                        }
                      >
